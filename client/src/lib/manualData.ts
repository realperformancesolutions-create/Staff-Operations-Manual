    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ...
          {
            amount: "$10.00",
            description: "Failure to Submit Practice Plan",
            notes: "Applied per missed practice plan submission. Consistent failure is grounds for a formal write-up.",
          },
          {
            amount: "$10.00",
            description: "Failure to Submit End of Day Report",
            notes: "Applied per missed EOD report. Consistent failure is grounds for a formal write-up.",
          },
          {
            amount: "$50.00",
      ...
      },
      {
        ...
        rows: [
          ...
          {
            amount: "$100.00",
            description: "Paid Bid Bonus",
            notes: "Awarded for earning a paid bid to a national championship event. Bids cannot be handed down — they must be earned through competition.",
          },
          {
            amount: "$50.00",
            description: "Partial Paid Bid Bonus",
            notes: "Awarded for earning a partial paid bid. Same qualification rules apply — bids cannot be handed down.",
          },
          {
            amount: "$25.00",
            description: "At-Large Bid Bonus",
            notes: "Awarded for earning an at-large bid. Same qualification rules apply — bids cannot be handed down.",
          },
          {
            amount: "$200.00",
            description: "Undefeated Season Bonus",
            notes: "Awarded for completing the competitive season without a loss. All competitions must have active competition in the division.",
          },
          {
            amount: "$300.00",
            description: "Best Retention Rate Bonus",
            notes: "Awarded to the coach with the highest athlete retention rate at the end of the season. Retention is calculated based on returning athletes from the prior season.",
          },
        ],
      },
      {
